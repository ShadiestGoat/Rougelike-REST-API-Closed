...
const command:Command = {
    name: "drop",
    desc: "Drops an item, as in removes it off your person. Forever.",
    group: "Inventory",
    perm: "Member",
    cooldown: 5,
    args: [{name:"id", required:true, description:"id of the item you want gone", type:"INTEGER"}],
    async execute(msg, tools, _args) {
        ...
        const User = await api.Drop(args.id)
